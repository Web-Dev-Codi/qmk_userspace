 ...
 */
 ...
 [_QWERTZ] = LAYOUT(
    ...
    KC_LCTL, KC_Y, KC_X, KC_C,  KC_V,    KC_B,    KC_MUTE,          KC_NO, KC_N ,   KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
        KC_LALT, LGUI(KC_LSFT), KC_LGUI, TL_LOWR, KC_SPC ,         KC_ENT, TL_UPPR, _______, KC_RGUI, KC_RCTL
  ),
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_GERMAN] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_PGDN, KC_PGUP) },
